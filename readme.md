...
> A curated list of tools and platforms for modern marketers, from ads, email, and SEO to analytics, automation, and CRM.

🌐 **[Browse the live site →](https://tractiongroup.github.io/awesome-marketing-tools/)**

<p align="center">
  <img src="media/logo.jpg" width="450" alt="Awesome Marketing Tools">
</p>
...
- [Cold Email & B2B Outbound](#cold-email--b2b-outbound)
...
- [Bïrch (formerly Revealbot)](https://bir.ch/) - Automating Facebook, Instagram, and Google ads.
...
- [Kit (formerly ConvertKit)](https://kit.com/) - Email marketing for creators and bloggers.
...
- [Screpy](https://screpy.com/) - AI SEO platform for technical audits, rank tracking, Core Web Vitals, uptime monitoring, and reports.
...
- [Marketing Cloud Account Engagement (formerly Pardot)](https://www.salesforce.com/marketing/b2b-automation/) - B2B marketing automation by Salesforce.
- [Ortto (formerly Autopilot)](https://ortto.com/) - Visual marketing automation software.
...
- [Aspire (formerly AspireIQ)](https://www.aspire.io/) - Influencer marketing and content creation platform.
...
- [Optux AI (formerly OptimalUX)](https://optux.ai/) - Seamless SEO patching and A/B testing tool built on Cloudflare for effortless integration.
...
Find, enrich, and automate B2B outbound and cold-email outreach.
